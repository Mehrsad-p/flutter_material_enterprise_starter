...
/// See also [initializeAppUseCase].
@ProviderFor(initializeAppUseCase)
final initializeAppUseCaseProvider =
    AutoDisposeProvider<InitializeAppUseCase>.internal(
      initializeAppUseCase,
      name: r'initializeAppUseCaseProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$initializeAppUseCaseHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final launcherControllerProvider =
    AutoDisposeNotifierProvider<LauncherController, LauncherState>.internal(
      LauncherController.new,
      name: r'launcherControllerProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$launcherControllerHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$LauncherController = AutoDisposeNotifier<LauncherState>;
