...
mixin _$ThemeState {
 ...
 ThemeMode get themeMode; Color? get seedColor;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeState&&(identical(other.themeMode, themeMode) || other.themeMode == themeMode)&&(identical(other.seedColor, seedColor) || other.seedColor == seedColor));
}


@override
int get hashCode => Object.hash(runtimeType,themeMode,seedColor);

@override
String toString() {
  return 'ThemeState(themeMode: $themeMode, seedColor: $seedColor)';
}
...
@useResult
$Res call({
 ThemeMode themeMode, Color? seedColor
});
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? themeMode = null,Object? seedColor = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  Color? seedColor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.themeMode,_that.seedColor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  Color? seedColor)  $default,) {final _that = this;
switch (_that) {
case _ThemeState():
return $default(_that.themeMode,_that.seedColor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  Color? seedColor)?  $default,) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.themeMode,_that.seedColor);case _:
  return null;
...
class _ThemeState implements ThemeState {
   _ThemeState({this.themeMode = ThemeMode.system, this.seedColor});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeState&&(identical(other.themeMode, themeMode) || other.themeMode == themeMode)&&(identical(other.seedColor, seedColor) || other.seedColor == seedColor));
}
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? themeMode = null,Object? seedColor = freezed,}) {
